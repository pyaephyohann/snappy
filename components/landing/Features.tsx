        ...
        >
          {FEATURES.map((feature) => (
            <motion.div
              ...
              className="group relative bg-card border border-border/60 rounded-2xl p-6 sm:p-8 transition-all duration-300 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5"
            >
              <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center text-primary mb-5 group-hover:bg-primary/15 group-hover:scale-110 transition-all duration-300">
                {feature.icon}
              </div>
